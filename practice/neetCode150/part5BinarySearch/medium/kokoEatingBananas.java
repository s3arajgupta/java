...
public class kokoEatingBananas {
    ...
    // To make the code more memory-efficient, you can avoid pre-allocating the
    // array k and instead dynamically determine the range of values to search for
    // the optimal solution. Here's the modified version:
