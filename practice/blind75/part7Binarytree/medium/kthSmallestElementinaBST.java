package practice.blind75.part7Binarytree.medium;
...
public class kthSmallestElementinaBST {
    ...
    // public static void findDeque(TreeNode root) {
    //     if (root == null) return;
    //     findDeque(root.left);
    //     deque.add(root.val);
    //     findDeque(root.right);
    // }
    // public static int kthSmallest(TreeNode root, int k) {

    //     findDeque(root);
    //     Integer[] res = deque.toArray(new Integer[deque.size()]);
